...
const OTPVerification = () => {
  ...
  const handleVerify = async () => {
    ...
    // TODO: Replace this timeout with real API call to verify OTP
    setTimeout(() => {
      setLoading(false);

      // If API says OTP is correct:
      toast.success('Login successful!');

      // 🔐 Mock login: store token + role in localStorage
      // In real app, you'd store a JWT or something from backend.
      localStorage.setItem('token', 'dummy-token');
      localStorage.setItem('role', 'admin'); // or 'admin' based on API response
